...
export const TOPICS: Record<Language, { icon: string; label: string; speech: string }[]> = {
  ...
  pt: [
    ...
    { icon: "house", label: "Empadro-\nnamento", speech: "Empadronamento" },
    { icon: "health", label: "Saúde", speech: "Cartão de saúde" },
    { icon: "doc", label: "NIE/TIE", speech: "NIE ou TIE" },
  ],
  ro: [
    { icon: "coin", label: "Ajutor\nfinanciar", speech: "Ajutor financiar" },
    { icon: "house", label: "Înregistrare\nmunicipală", speech: "Înregistrare municipală" },
    { icon: "health", label: "Sănătate", speech: "Card de sănătate" },
    { icon: "doc", label: "NIE/TIE", speech: "NIE sau TIE" },
  ],
  ca: [
    { icon: "coin", label: "Ajuda\neconòmica", speech: "Ajuda econòmica" },
    { icon: "house", label: "Empadro-\nnament", speech: "Empadronament" },
    { icon: "health", label: "Salut", speech: "Targeta sanitària" },
    { icon: "doc", label: "NIE/TIE", speech: "NIE o TIE" },
  ],
  zh: [
    { icon: "coin", label: "经济\n援助", speech: "经济援助" },
    { icon: "house", label: "市政\n登记", speech: "市政登记" },
    { icon: "health", label: "健康", speech: "健康卡" },
...
export const QUICK_REPLIES: Record<Language, string[]> = {
  ...
  pt: ["O que é o IMV?", "Como me registo?", "Cartão de saúde"],
  ro: ["Ce este VMI?", "Cum mă înregistrez?", "Card de sănătate"],
  ca: ["Què és l'IMV?", "Com m'empadrono?", "Targeta sanitària"],
  zh: ["什么是最低生活保障？", "如何注册？", "健康卡"],
...
export const STATS: Record<Language, { value: string; label: string }[]> = {
  ...
  pt: [
    ...
    { value: "3+", label: "idiomas" },
    { value: "8", label: "trâmites" },
    { value: "<3s", label: "resposta" },
  ],
  ro: [
    { value: "17", label: "regiuni" },
    { value: "3+", label: "limbi" },
    { value: "8", label: "proceduri" },
    { value: "<3s", label: "răspuns" },
  ],
  ca: [
    { value: "17", label: "CCAA" },
    { value: "3+", label: "idiomes" },
    { value: "8", label: "tràmits" },
    { value: "<3s", label: "resposta" },
  ],
  zh: [
    { value: "17", label: "地区" },
...
export const SUGGESTIONS: Record<Language, string[]> = {
  ...
  pt: ["O que é o IMV?", "Empadronamento", "Cartão de saúde", "Renovar NIE"],
  ro: ["Ce este VMI?", "Înregistrare municipală", "Card de sănătate", "Reînnoire NIE"],
  ca: ["Què és l'IMV?", "Empadronament", "Targeta sanitària", "Renovar NIE"],
  zh: ["什么是最低生活保障？", "市政登记", "健康卡", "更新NIE"],
