...
export const TOPICS: Record<Language, { icon: string; label: string; speech: string }[]> = {
  es: [
    { icon: "coin", label: "Ayudas\neconómicas", speech: "Ayudas económicas como IMV, pensiones o subsidios" },
    { icon: "house", label: "Vivienda y\nregistro", speech: "Empadronamiento y bono social eléctrico" },
    { icon: "health", label: "Salud y\nfamilia", speech: "Tarjeta sanitaria, baja maternidad y dependencia" },
    { icon: "doc", label: "Extranjería", speech: "NIE, TIE, arraigo y reagrupación familiar" },
  ],
  en: [
  ...
  fr: [
    { icon: "coin", label: "Aides\nfinancières", speech: "Aides financières comme le RMV, pensions ou allocations" },
    { icon: "house", label: "Logement et\ninscription", speech: "Inscription municipale et bon social électrique" },
    { icon: "health", label: "Santé et\nfamille", speech: "Carte sanitaire, congé maternité et dépendance" },
...
export const QUIENES_SOMOS_STORY: Record<Language, {
  ...
  es: {
    empatizar: {
      title: "Esto no debería ser tan difícil",
      body: "Sabemos lo que es sentarse en una oficina pública sin entender una palabra. Ese nudo en el estómago cuando te dan un formulario de cuatro páginas en español jurídico. Ese miedo a preguntar porque no quieres molestar. Esa sensación de que el sistema no fue hecho para ti.",
      stat: "No estás sola. 4.5 millones de personas en España pasan por esto cada día.",
    },
    validar: {
      title: "Entender tus derechos no debería ser un privilegio",
      body: "Si vives en España, tienes derechos. Derecho a la sanidad. Derecho al empadronamiento. Derecho a ayudas económicas si las necesitas. Pero acceder a ellos requiere navegar un laberinto de formularios, webs y oficinas que no fueron diseñados pensando en ti.",
      closing: "Eso no está bien.",
    },
    momento: {
      title: "Por eso existe Clara",
      body: "En febrero de 2026, cinco personas nos sentamos en un hackathon con una pregunta: Y si pudieras acceder a tus derechos simplemente hablando?\n\nNo queríamos construir otro chatbot. Queríamos construir algo que funcionara como funciona la vida real: le cuentas a alguien tu situación, y esa persona te dice exactamente qué hacer, paso a paso, en tu idioma.\n\nAsí nació Clara.",
    },
    equipo: {
      title: "Quiénes somos",
      intro: "No somos los héroes de esta historia — los héroes sois vosotros.",
      members: [
        { name: "Andrea", role: "Creadora de Clara" },
        { name: "Robert", role: "Co-creador" },
        { name: "Marcos", role: "Co-creador" },
        { name: "Lucas", role: "Co-creador" },
        { name: "Daniel", role: "Co-creador" },
      ],
    },
    cta: {
      title: "Tu voz tiene poder",
      body: "Clara está lista para ayudarte. Habla o escribe en tu idioma.",
  ...
  en: {
    ...
    equipo: {
      ...
      members: [
        ...
        { name: "Robert", role: "Co-creator" },
        { name: "Marcos", role: "Co-creator" },
        { name: "Lucas", role: "Co-creator" },
        { name: "Daniel", role: "Co-creator" },
      ],
    },
    cta: {
  ...
  fr: {
    empatizar: {
      title: "Ça ne devrait pas être aussi difficile",
      body: "Nous savons ce que c'est de s'asseoir dans un bureau public sans comprendre un mot. Ce nœud dans l'estomac quand on te donne un formulaire de quatre pages en espagnol juridique. Cette peur de demander parce que tu ne veux pas déranger.",
      stat: "Tu n'es pas seule. 4,5 millions de personnes en Espagne vivent ça chaque jour.",
    },
    validar: {
      title: "Comprendre tes droits ne devrait pas être un privilège",
      body: "Si tu vis en Espagne, tu as des droits. Droit à la santé. Droit à l'inscription municipale. Droit aux aides économiques si tu en as besoin. Mais y accéder exige de naviguer un labyrinthe de formulaires et de bureaux qui n'ont pas été conçus pour toi.",
      closing: "Ce n'est pas normal.",
    },
    momento: {
      title: "C'est pour ça que Clara existe",
      body: "En février 2026, cinq personnes se sont assises à un hackathon avec une question: Et si tu pouvais accéder à tes droits simplement en parlant?\n\nNous ne voulions pas construire un autre chatbot. Nous voulions construire quelque chose qui fonctionne comme la vraie vie: tu racontes ta situation, et on te dit exactement quoi faire, étape par étape, dans ta langue.\n\nC'est ainsi que Clara est née.",
    },
    equipo: {
      title: "Qui sommes-nous",
      intro: "Nous ne sommes pas les héros de cette histoire — les héros, c'est vous.",
      members: [
        { name: "Andrea", role: "Créatrice de Clara" },
        { name: "Robert", role: "Co-créateur" },
        { name: "Marcos", role: "Co-créateur" },
        { name: "Lucas", role: "Co-créateur" },
        { name: "Daniel", role: "Co-créateur" },
      ],
    },
    cta: {
      title: "Ta voix a du pouvoir",
      body: "Clara est prête à t'aider. Parle ou écris dans ta langue.",
  ...
  pt: {
    ...
    equipo: {
      ...
      members: [
        ...
        { name: "Robert", role: "Co-criador" },
        { name: "Marcos", role: "Co-criador" },
        { name: "Lucas", role: "Co-criador" },
        { name: "Daniel", role: "Co-criador" },
      ],
    },
    cta: {
  ...
  zh: {
    ...
    equipo: {
      ...
      members: [
        ...
        { name: "Robert", role: "联合创造者" },
        { name: "Marcos", role: "联合创造者" },
        { name: "Lucas", role: "联合创造者" },
        { name: "Daniel", role: "联合创造者" },
      ],
    },
    cta: {
      title: "你的声音有力量",
  ...
  ar: {
    ...
    equipo: {
      ...
      members: [
        ...
        { name: "Robert", role: "مُشارك في الإنشاء" },
        { name: "Marcos", role: "مُشارك في الإنشاء" },
        { name: "Lucas", role: "مُشارك في الإنشاء" },
        { name: "Daniel", role: "مُشارك في الإنشاء" },
      ],
    },
    cta: {
      title: "صوتك له قوة",
...
export const COMO_USAR_PAGE: Record<Language, {
  ...
  es: {
    empathy_headline: "Tu idioma es suficiente",
    empathy_sub: "4 de cada 10 personas inmigrantes en España no hablan español como lengua materna. Clara entiende tu idioma y te explica cada trámite paso a paso, con información oficial.",
    steps_title: "Así funciona",
    steps: [
      { title: "Abre Clara", desc: "Por WhatsApp o desde la web. Ya tienes todo lo que necesitas: no hace falta descargar nada." },
      { title: "Elige tu idioma", desc: "Árabe, francés, chino, rumano, portugués, catalán, inglés o español. Clara habla como tú." },
      { title: "Habla o escribe", desc: "Envía una nota de voz como harías con un amigo. Si prefieres escribir, también funciona." },
      { title: "Recibe tu respuesta", desc: "Pasos claros, enlaces al gobierno real y todo explicado en tu idioma. Sin sorpresas ni letra pequeña." },
    ],
    ...
    cta_headline: "Casi 10 millones de personas construyen España desde fuera",
    cta_sub: "Si eres una de ellas, tus preguntas importan. Clara está aquí para que ningún trámite te deje sin respuesta.",
    cta_button: "Habla con Clara",
  },
  en: {
    empathy_headline: "Your language is enough",
    empathy_sub: "73% of immigrants in Spain never finish government procedures because of digital and language barriers. Clara speaks your language and walks you through every step.",
    steps_title: "How it works",
    steps: [
      { title: "Open Clara", desc: "On WhatsApp or the web. You already have everything you need — no app to download." },
      { title: "Pick your language", desc: "Arabic, French, Chinese, Romanian, Portuguese, Catalan, Spanish or English. Clara meets you where you are." },
      { title: "Speak or type", desc: "Send a voice note, just like you would to a friend. Typing works too, whatever feels easier." },
      { title: "Get your answer", desc: "Clear steps, real government links, everything explained in your language. No hidden conditions." },
    ],
    ...
    cta_headline: "Nearly 10 million people built their lives in Spain",
    cta_sub: "If you're one of them, your questions matter. Clara is here so no procedure leaves you without an answer.",
    cta_button: "Talk to Clara",
  },
  fr: {
    empathy_headline: "Ta langue suffit",
    empathy_sub: "40% des personnes immigrées en Espagne ne parlent pas espagnol comme langue maternelle. Clara comprend ta langue et t'explique chaque démarche, étape par étape, avec des sources officielles.",
    steps_title: "Comment ça marche",
    steps: [
      { title: "Ouvre Clara", desc: "Sur WhatsApp ou depuis le web. Tu as déjà tout ce qu'il faut — rien à télécharger." },
      { title: "Choisis ta langue", desc: "Français, arabe, chinois, roumain, portugais, catalan, espagnol ou anglais. Clara te comprend." },
      { title: "Parle ou écris", desc: "Envoie un vocal, comme tu ferais avec un ami. Si tu préfères écrire, ça marche aussi." },
      { title: "Reçois ta réponse", desc: "Des étapes claires, des liens vers les sites du gouvernement, tout dans ta langue. Sans conditions cachées." },
    ],
    ...
    cta_headline: "Près de 10 millions de personnes construisent l'Espagne",
    cta_sub: "Si tu en fais partie, tes questions comptent. Clara est là pour qu'aucune démarche ne reste sans réponse.",
    cta_button: "Parle avec Clara",
  },
  pt: {
    empathy_headline: "A tua língua é suficiente",
    empathy_sub: "73% das pessoas imigrantes em Espanha não completam os trâmites por barreiras digitais e linguísticas. Clara fala a tua língua e guia-te em cada passo, com informação oficial.",
    steps_title: "Como funciona",
    steps: [
      { title: "Abre Clara", desc: "No WhatsApp ou na web. Já tens tudo o que precisas — não é preciso descarregar nada." },
      { title: "Escolhe o teu idioma", desc: "Português, árabe, francês, chinês, romeno, catalão, espanhol ou inglês. Clara entende-te." },
      { title: "Fala ou escreve", desc: "Envia um áudio, como farias com um amigo. Se preferires escrever, também funciona." },
      { title: "Recebe a tua resposta", desc: "Passos claros, links oficiais do governo, tudo explicado na tua língua. Sem surpresas." },
    ],
    ...
    cta_headline: "Quase 10 milhões de pessoas construíram a sua vida em Espanha",
    cta_sub: "Se és uma delas, as tuas perguntas importam. Clara está aqui para que nenhum trâmite fique sem resposta.",
    cta_button: "Fala com Clara",
  },
  ro: {
    empathy_headline: "Limba ta e de ajuns",
    empathy_sub: "73% dintre imigranții din Spania nu finalizează procedurile din cauza barierelor digitale și lingvistice. Clara vorbește limba ta și te ghidează pas cu pas, cu informații oficiale.",
    steps_title: "Cum funcționează",
    steps: [
      { title: "Deschide Clara", desc: "Pe WhatsApp sau pe web. Ai deja tot ce îți trebuie — nu trebuie să descarci nimic." },
      { title: "Alege limba ta", desc: "Română, arabă, franceză, chineză, portugheză, catalană, spaniolă sau engleză. Clara te înțelege." },
      { title: "Vorbește sau scrie", desc: "Trimite un mesaj vocal, așa cum ai face cu un prieten. Dacă preferi să scrii, merge și așa." },
      { title: "Primește răspunsul", desc: "Pași clari, linkuri către site-urile guvernului, totul explicat în limba ta. Fără condiții ascunse." },
    ],
    ...
    cta_headline: "Aproape 10 milioane de oameni și-au construit viața în Spania",
    cta_sub: "Dacă ești unul dintre ei, întrebările tale contează. Clara e aici ca nicio procedură să nu rămână fără răspuns.",
    cta_button: "Vorbește cu Clara",
  },
  ca: {
    empathy_headline: "El teu idioma és suficient",
    empathy_sub: "El 40% de les persones immigrades a Espanya no parlen castellà com a llengua materna. Clara entén el teu idioma i t'explica cada tràmit pas a pas, amb informació oficial.",
    steps_title: "Així funciona",
    steps: [
      { title: "Obre Clara", desc: "Per WhatsApp o des del web. Ja tens tot el que necessites: no cal descarregar res." },
      { title: "Tria el teu idioma", desc: "Català, àrab, francès, xinès, romanès, portuguès, castellà o anglès. Clara et comprendrà." },
      { title: "Parla o escriu", desc: "Envia una nota de veu, com faries amb un amic. Si prefereixes escriure, també funciona." },
      { title: "Rep la teva resposta", desc: "Passos clars, enllaços al govern real i tot explicat en el teu idioma. Sense sorpreses ni lletra petita." },
    ],
    ...
    cta_headline: "Gairebé 10 milions de persones construeixen Espanya",
    cta_sub: "Si ets una d'elles, les teves preguntes importen. Clara és aquí perquè cap tràmit et deixi sense resposta.",
    cta_button: "Parla amb Clara",
  },
  zh: {
    empathy_headline: "你的语言就够了",
    empathy_sub: "在西班牙，40%的移民不以西班牙语为母语。Clara懂你的语言，用官方信息一步步带你完成每一项手续。",
    steps_title: "使用方法",
    steps: [
      { title: "打开Clara", desc: "通过WhatsApp或网页即可使用。你已经有了所需的一切，无需下载任何东西。" },
      { title: "选择你的语言", desc: "中文、阿拉伯语、法语、罗马尼亚语、葡萄牙语、加泰罗尼亚语、西班牙语或英语。Clara听得懂你。" },
      { title: "说话或打字", desc: "发送语音消息，就像跟朋友聊天一样。如果你更喜欢打字，也完全可以。" },
      { title: "获得你的答案", desc: "清晰的步骤、真实的政府链接，全部用你的语言解释。没有隐藏条件。" },
    ],
    ...
    cta_headline: "近一千万人在西班牙建立了自己的生活",
    cta_sub: "如果你是其中之一，你的问题很重要。Clara在这里，让每一项手续都不再无解。",
    cta_button: "和Clara对话",
  },
  ar: {
    empathy_headline: "لغتك تكفي",
    empathy_sub: "40% من المهاجرين في إسبانيا لا يتحدثون الإسبانية كلغة أم. كلارا تفهم لغتك وتشرح لك كل إجراء خطوة بخطوة، بمعلومات رسمية موثقة.",
    steps_title: "كيف يعمل",
    steps: [
      { title: "افتح كلارا", desc: "عبر واتساب أو من الموقع. عندك كل ما تحتاجه — لا تحميل ولا تثبيت." },
      { title: "اختر لغتك", desc: "العربية، الفرنسية، الصينية، الرومانية، البرتغالية، الكتالانية، الإسبانية أو الإنجليزية. كلارا تفهمك." },
      { title: "تكلم أو اكتب", desc: "أرسل رسالة صوتية، مثل ما تسوي مع صاحبك. لو تفضل الكتابة، تشتغل بردو." },
      { title: "احصل على جوابك", desc: "خطوات واضحة، روابط مواقع حكومية حقيقية، كل شيء بلغتك. بدون شروط مخفية." },
    ],
    ...
    cta_headline: "قريب من 10 ملايين شخص بنوا حياتهم في إسبانيا",
    cta_sub: "لو أنت واحد منهم، أسئلتك مهمة. كلارا هنا عشان ما يبقى أي إجراء بدون جواب.",
    cta_button: "تحدث مع كلارا",
  },
};

/* ------------------------------------------------------------------ */
/*  Como Usar Page — New bento/dock keys                              */
/* ------------------------------------------------------------------ */

export const COMO_USAR_EXTRA: Record<Language, {
  hero_talk_button: string;
  hero_guide_button: string;
  practice_title: string;
  practice_desc: string;
  practice_cta: string;
  local_examples_title: string;
  chips: string[];
  quick_help_title: string;
  quick_help_mic: string;
  quick_help_mic_desc: string;
  quick_help_volume: string;
  quick_help_volume_desc: string;
  quick_help_share: string;
  quick_help_share_desc: string;
  dock_talk: string;
  dock_guide: string;
  dock_language: string;
  trust_free: string;
  ...
  es: {
    hero_talk_button: "Hablar con Clara",
    hero_guide_button: "Ver la guía",
    practice_title: "Practica ahora",
    practice_desc: "No necesitas saber usar tecnología. Solo pulsa el botón y pregunta lo que necesites. Clara tiene paciencia infinita.",
    practice_cta: "Intentar",
    local_examples_title: "Temas frecuentes",
    chips: ["Empadronarme", "Ingreso Mínimo", "Tarjeta sanitaria", "Papeles de residencia"],
    quick_help_title: "Ayuda rápida",
    quick_help_mic: "Micrófono",
    quick_help_mic_desc: "Pulsa el círculo y habla tranquilamente, como si le contaras a una amiga. Clara te escucha.",
    quick_help_volume: "Volumen",
    quick_help_volume_desc: "Clara te responde con voz, para que no tengas que leer. Sube el volumen de tu teléfono.",
    quick_help_share: "Compartir",
    quick_help_share_desc: "¿Conoces a alguien que lo necesita? Envía este enlace. No pide registro ni datos.",
    dock_talk: "Hablar",
    dock_guide: "Guía",
    dock_language: "Idioma",
    trust_free: "Gratis",
    trust_private: "Privado",
    trust_247: "24/7",
    hero_stat: "1 de cada 5 personas en España nació en otro país",
  },
  en: {
    hero_talk_button: "Talk to Clara",
    hero_guide_button: "See the guide",
    practice_title: "Practice now",
    practice_desc: "You don't need to be good with technology. Just press the button and ask what you need. Clara is patient.",
    practice_cta: "Try it",
    local_examples_title: "Common topics",
    chips: ["Registration", "Minimum income", "Health card", "Residence permit"],
    quick_help_title: "Quick help",
    quick_help_mic: "Microphone",
    quick_help_mic_desc: "Tap the circle and speak naturally, like you're talking to a friend. Clara is listening.",
    quick_help_volume: "Volume",
    quick_help_volume_desc: "Clara answers with voice so you don't have to read. Turn up your phone volume.",
    quick_help_share: "Share",
    quick_help_share_desc: "Know someone who needs this? Send them the link. No sign-up, no personal data.",
    dock_talk: "Talk",
    dock_guide: "Guide",
    dock_language: "Language",
    trust_free: "Free",
    trust_private: "Private",
    trust_247: "24/7",
    hero_stat: "1 in 5 people in Spain were born in another country",
  },
  fr: {
    hero_talk_button: "Parler avec Clara",
    hero_guide_button: "Voir le guide",
    practice_title: "Essaie maintenant",
    practice_desc: "Pas besoin d'être à l'aise avec la technologie. Appuie sur le bouton et pose ta question. Clara est patiente.",
    practice_cta: "Essayer",
    local_examples_title: "Sujets fréquents",
    chips: ["Inscription mairie", "Revenu minimum", "Carte de santé", "Titre de séjour"],
    quick_help_title: "Aide rapide",
    quick_help_mic: "Microphone",
    quick_help_mic_desc: "Appuie sur le cercle et parle normalement, comme si tu parlais à un ami. Clara t'écoute.",
    quick_help_volume: "Volume",
    quick_help_volume_desc: "Clara répond par la voix pour que tu n'aies pas besoin de lire. Monte le son de ton téléphone.",
    quick_help_share: "Partager",
    quick_help_share_desc: "Tu connais quelqu'un qui en a besoin? Envoie-lui le lien. Pas d'inscription, pas de données.",
    dock_talk: "Parler",
    dock_guide: "Guide",
    dock_language: "Langue",
    trust_free: "Gratuit",
    trust_private: "Privé",
    trust_247: "24/7",
    hero_stat: "1 personne sur 5 en Espagne est née dans un autre pays",
  },
  pt: {
    hero_talk_button: "Falar com Clara",
    hero_guide_button: "Ver o guia",
    practice_title: "Pratica agora",
    practice_desc: "Nao precisas de perceber de tecnologia. Carrega no botao e pergunta o que precisares. Clara tem toda a paciencia.",
    practice_cta: "Experimentar",
    local_examples_title: "Temas frequentes",
    chips: ["Empadronamento", "Rendimento minimo", "Cartao de saude", "Autorizacao de residencia"],
    quick_help_title: "Ajuda rapida",
    quick_help_mic: "Microfone",
    quick_help_mic_desc: "Carrega no circulo e fala com calma, como se falasses com um amigo. Clara esta a ouvir-te.",
    quick_help_volume: "Volume",
    quick_help_volume_desc: "Clara responde com voz para que nao tenhas de ler. Aumenta o volume do telemovel.",
    quick_help_share: "Partilhar",
    quick_help_share_desc: "Conheces alguem que precisa disto? Envia o link. Sem registo, sem dados pessoais.",
    dock_talk: "Falar",
    dock_guide: "Guia",
    dock_language: "Idioma",
    trust_free: "Gratuito",
    trust_private: "Privado",
    trust_247: "24/7",
    hero_stat: "1 em cada 5 pessoas em Espanha nasceu noutro pais",
  },
  ro: {
    hero_talk_button: "Vorbeste cu Clara",
    hero_guide_button: "Vezi ghidul",
    practice_title: "Exerseaza acum",
    practice_desc: "Nu trebuie sa te pricepi la tehnologie. Apasa butonul si intreaba ce ai nevoie. Clara are rabdare infinita.",
    practice_cta: "Incearca",
    local_examples_title: "Subiecte frecvente",
    chips: ["Empadronamiento", "Venitul minim", "Cardul de sanatate", "Permis de rezidenta"],
    quick_help_title: "Ajutor rapid",
    quick_help_mic: "Microfon",
    quick_help_mic_desc: "Apasa cercul si vorbeste linistit, ca si cum ai vorbi cu un prieten. Clara te asculta.",
    quick_help_volume: "Volum",
    quick_help_volume_desc: "Clara raspunde cu voce ca sa nu fie nevoie sa citesti. Da volumul mai tare la telefon.",
    quick_help_share: "Distribuie",
    quick_help_share_desc: "Cunosti pe cineva care are nevoie? Trimite-i linkul. Fara inregistrare, fara date personale.",
    dock_talk: "Vorbeste",
    dock_guide: "Ghid",
    dock_language: "Limba",
    trust_free: "Gratuit",
    trust_private: "Privat",
    trust_247: "24/7",
    hero_stat: "1 din 5 persoane din Spania s-a nascut in alta tara",
  },
  ca: {
    hero_talk_button: "Parlar amb Clara",
    hero_guide_button: "Veure la guia",
    practice_title: "Practica ara",
    practice_desc: "No cal que sapigues de tecnologia. Prem el boto i pregunta el que necessitis. Clara te tota la paciencia del mon.",
    practice_cta: "Provar",
    local_examples_title: "Temes frequents",
    chips: ["Empadronament", "Ingres minim", "Targeta sanitaria", "Permis de residencia"],
    quick_help_title: "Ajuda rapida",
    quick_help_mic: "Microfon",
    quick_help_mic_desc: "Prem el cercle i parla tranquilament, com si expliquessis algo a un amic. Clara t'escolta.",
    quick_help_volume: "Volum",
    quick_help_volume_desc: "Clara et respon amb veu perque no hagis de llegir. Puja el volum del telefon.",
    quick_help_share: "Compartir",
    quick_help_share_desc: "Coneixes algu que ho necessita? Envia-li l'enllac. Sense registre ni dades personals.",
    dock_talk: "Parlar",
    dock_guide: "Guia",
    dock_language: "Idioma",
    trust_free: "Gratuit",
    trust_private: "Privat",
    trust_247: "24/7",
    hero_stat: "1 de cada 5 persones a Espanya va neixer en un altre pais",
  },
  zh: {
    hero_talk_button: "与Clara对话",
    hero_guide_button: "查看指南",
    practice_title: "现在练习",
    practice_desc: "不需要懂技术。按下按钮，问你想问的就好。Clara有无限的耐心。",
    practice_cta: "试试看",
    local_examples_title: "常见主题",
    chips: ["户籍登记", "最低生活保障金", "医疗卡", "居留许可"],
    quick_help_title: "快速帮助",
    quick_help_mic: "麦克风",
    quick_help_mic_desc: "点击圆圈，像跟朋友说话一样自然地讲。Clara在听。",
    quick_help_volume: "音量",
    quick_help_volume_desc: "Clara用语音回答你，这样你不需要阅读。请把手机音量调大。",
    quick_help_share: "分享",
    quick_help_share_desc: "认识需要帮助的人？把链接发给他们。不需要注册，不需要个人信息。",
    dock_talk: "对话",
    dock_guide: "指南",
    dock_language: "语言",
    trust_free: "免费",
    trust_private: "隐私",
    trust_247: "24/7",
    hero_stat: "在西班牙，每5个人中就有1个出生在另一个国家",
  },
  ar: {
    hero_talk_button: "تحدث مع كلارا",
    hero_guide_button: "شاهد الدليل",
    practice_title: "تمرن الآن",
    practice_desc: "ما تحتاج تكون خبير بالتكنولوجيا. اضغط الزر واسأل اللي تبيه. كلارا عندها صبر ما ينتهي.",
    practice_cta: "جرّب",
    local_examples_title: "مواضيع شائعة",
    chips: ["تسجيل بلدي", "الحد الأدنى للدخل", "البطاقة الصحية", "تصريح الإقامة"],
    quick_help_title: "مساعدة سريعة",
    quick_help_mic: "ميكروفون",
    quick_help_mic_desc: "اضغط على الدائرة وتكلم بطبيعتك، مثل ما تحكي مع صديق. كلارا تسمعك.",
    quick_help_volume: "مستوى الصوت",
    quick_help_volume_desc: "كلارا ترد عليك بالصوت عشان ما تحتاج تقرأ. ارفع صوت تلفونك.",
    quick_help_share: "مشاركة",
    quick_help_share_desc: "تعرف أحد يحتاج المساعدة؟ أرسله الرابط. بدون تسجيل وبدون بيانات شخصية.",
    dock_talk: "تحدث",
    dock_guide: "دليل",
    dock_language: "اللغة",
    trust_free: "مجاني",
    trust_private: "خاص",
    trust_247: "24/7",
    hero_stat: "شخص واحد من كل 5 في إسبانيا وُلد في بلد آخر",
  },
};
...
export const FUTURO_PAGE: Record<Language, {
  ...
  es: {
    ...
    hero_sub: "Clara nació para que nadie se quede sin información por no hablar el idioma o no entender el sistema. Pero todavía hay personas a las que no llegamos. Cada paso que damos es para ti.",
    roadmap_title: "Lo que viene — para ti",
    roadmap: [
      { title: "Más idiomas", benefit: "Para que nadie quede fuera por su idioma. Rumano, ucraniano, chino y más — porque cada persona merece entender.", status: "Próximo" },
      { title: "Más trámites", benefit: "Asilo, homologación de títulos, reagrupación familiar. Los trámites que más te preocupan, explicados con claridad.", status: "En desarrollo" },
      ...
      { title: "App sin conexión", benefit: "Porque no siempre hay wifi. Una app que funcione offline, en tu bolsillo, cuando la necesites.", status: "Futuro" },
    ],
    vision_headline: "El futuro que imaginamos",
    vision_text: "Un día, cualquier persona que llegue a España podrá preguntar y recibir una respuesta clara, en su idioma, sin miedo. Ese es el mundo que estamos construyendo. Contigo.",
    cta_headline: "Tu voz construye ese futuro",
    cta_sub: "Cada pregunta que haces nos ayuda a mejorar. Cada idioma que pedís, lo priorizamos. Clara crece contigo.",
    cta_button: "Habla con Clara",
  },
  en: {
  ...
  fr: {
    hero_headline: "Ce n'est que le début",
    hero_sub: "Clara est née pour que personne ne reste sans information par barrière linguistique ou bureaucratique. Mais il y a encore des personnes que nous n'atteignons pas. Chaque pas est pour toi.",
    roadmap_title: "Ce qui arrive — pour toi",
    roadmap: [
      { title: "Plus de langues", benefit: "Pour que personne ne soit exclu à cause de sa langue. Roumain, ukrainien, chinois et plus — parce que chacun mérite de comprendre.", status: "Prochain" },
      { title: "Plus de démarches", benefit: "Asile, reconnaissance de diplômes, regroupement familial. Les démarches qui te préoccupent le plus, expliquées clairement.", status: "En cours" },
      { title: "Partenariats réels", benefit: "Pour que ta mairie, ton ONG, ton assistant social connaisse Clara. Pour que l'aide arrive là où il faut.", status: "Exploration" },
    ...
    vision_text: "Un jour, toute personne arrivant en Espagne pourra poser une question et recevoir une réponse claire, dans sa langue, sans peur. C'est le monde que nous construisons. Avec toi.",
    cta_headline: "Ta voix construit ce futur",
    cta_sub: "Chaque question que tu poses nous aide à nous améliorer. Chaque langue demandée, nous la priorisons. Clara grandit avec toi.",
    cta_button: "Parle avec Clara",
  },
  pt: {
...
export const LEGAL_PAGE: Record<Language, {
  ...
  es: {
    intro: "Clara se compromete con la transparencia. Aquí explicamos cómo funciona nuestra inteligencia artificial y cómo protegemos tus datos.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Soy un sistema de inteligencia artificial, no una persona. Mis respuestas son generadas automáticamente por modelos de lenguaje.",
          "La información que proporciono es orientativa y no sustituye el asesoramiento profesional de abogados, trabajadores sociales u organismos oficiales.",
          "Un equipo humano supervisa mi funcionamiento y actualiza mi base de conocimiento periódicamente.",
        ],
      },
      {
        icon: "data",
        ...
        paragraphs: [
          "Procesamos el texto y audio que nos envías únicamente para generar respuestas a tus consultas.",
          "No almacenamos documentos de identidad (DNI, NIE, pasaporte) ni datos bancarios.",
          "Las sesiones de conversación son temporales y no se vinculan a perfiles permanentes.",
        ],
      },
      {
        icon: "services",
        ...
        paragraphs: [
          "Utilizamos Google (Gemini) para procesamiento de lenguaje, ElevenLabs para síntesis de voz, y Meta para la comunicación por WhatsApp.",
          "Solo compartimos los datos mínimos necesarios para que estos servicios funcionen.",
          "Puedes consultar sus políticas de privacidad en sus respectivos sitios web.",
        ],
      },
      {
        icon: "clock",
        ...
        paragraphs: [
          "El audio que envías se procesa de forma transitoria y no se almacena permanentemente.",
          "No creamos perfiles permanentes de usuarios ni historiales de conversación a largo plazo.",
      ...
      },
      {
        ...
        paragraphs: [
          "Puedes dejar de usar Clara en cualquier momento sin necesidad de justificación.",
          "Tienes derecho a solicitar información sobre el tratamiento de tus datos.",
          "Puedes reclamar ante la Agencia Española de Protección de Datos (AEPD) si consideras que tus derechos han sido vulnerados.",
        ],
      },
      {
        icon: "handshake",
        ...
        paragraphs: [
          "Al usar Clara, aceptas el procesamiento de datos descrito en esta página para poder ofrecerte respuestas.",
          "Puedes retirar tu consentimiento en cualquier momento simplemente dejando de usar el servicio.",
        ],
      },
      {
        icon: "shield",
        heading: "Protección especial",
        paragraphs: [
          "Clara está diseñada pensando en personas en situación de vulnerabilidad.",
  ...
  fr: {
    intro: "Clara s'engage pour la transparence. Nous expliquons ici comment fonctionne notre intelligence artificielle et comment nous protégeons vos données.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Je suis un système d'intelligence artificielle, pas une personne. Mes réponses sont générées automatiquement par des modèles de langage.",
          ...
          "Une équipe humaine supervise mon fonctionnement et met à jour ma base de connaissances périodiquement.",
        ],
      },
      {
        icon: "data",
        ...
        paragraphs: [
          "Nous traitons le texte et l'audio que vous nous envoyez uniquement pour générer des réponses à vos questions.",
          "Nous ne stockons pas les documents d'identité (DNI, NIE, passeport) ni les coordonnées bancaires.",
          "Les sessions de conversation sont temporaires et ne sont pas liées à des profils permanents.",
        ],
      },
      {
        icon: "services",
        ...
        paragraphs: [
          "Nous utilisons Google (Gemini) pour le traitement du langage, ElevenLabs pour la synthèse vocale, et Meta pour la communication WhatsApp.",
          "Nous ne partageons que les données minimales nécessaires au fonctionnement de ces services.",
          "Vous pouvez consulter leurs politiques de confidentialité sur leurs sites respectifs.",
        ],
      },
      {
        icon: "clock",
        ...
        paragraphs: [
          "L'audio que vous envoyez est traité de manière transitoire et n'est pas stocké de manière permanente.",
          "Nous ne créons pas de profils d'utilisateurs permanents ni d'historiques de conversation à long terme.",
          "Nous n'utilisons pas de cookies de suivi ni de technologies de traçage publicitaire.",
        ],
      },
      {
        icon: "rights",
        heading: "Vos droits",
        paragraphs: [
          "Vous pouvez cesser d'utiliser Clara à tout moment sans avoir à vous justifier.",
          "Vous avez le droit de demander des informations sur le traitement de vos données.",
          "Vous pouvez déposer une plainte auprès de l'Agence espagnole de protection des données (AEPD) si vous estimez que vos droits ont été violés.",
        ],
      },
      {
        icon: "handshake",
        ...
        paragraphs: [
          "En utilisant Clara, vous acceptez le traitement des données décrit sur cette page afin de recevoir des réponses.",
          "Vous pouvez retirer votre consentement à tout moment en cessant simplement d'utiliser le service.",
        ],
      },
      {
        icon: "shield",
        heading: "Protection spéciale",
        paragraphs: [
          "Clara est conçue en pensant aux personnes en situation de vulnérabilité.",
          "Nous ne profilons pas les utilisateurs et ne prenons pas de décisions automatisées ayant des effets juridiques.",
          "Notre développement suit les principes d'OdiseIA4Good pour une IA responsable et inclusive.",
        ],
      },
    ],
  },
