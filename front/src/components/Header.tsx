    ...
    <header className="sticky top-0 z-10 flex items-center justify-between px-4 h-[56px] bg-clara-blue text-white">
      ...
      <div className="flex items-center gap-2">
        <svg width="28" height="28" viewBox="0 0 80 80" fill="none" aria-hidden="true">
          <path d="M 28 14 A 30 30 0 0 1 28 66" stroke="white" strokeWidth="4.5" strokeLinecap="round" fill="none" opacity="0.35" />
          <path d="M 28 23 A 20 20 0 0 1 28 57" stroke="white" strokeWidth="4.5" strokeLinecap="round" fill="none" opacity="0.65" />
          <path d="M 28 32 A 10 10 0 0 1 28 48" stroke="white" strokeWidth="4.5" strokeLinecap="round" fill="none" opacity="1" />
      ...
      >
        ...
        <option value="ar" className="text-clara-text">AR</option>
      </select>
    </header>
  );
}
