...
const labels = {
  ...
  pt: {
    ...
    error: "Audio indisponivel",
    loading: "A carregar audio...",
    progress: "Progresso do audio",
  },
  ro: {
    play: "Asculta raspunsul",
    playWithDuration: (d: string) => `Asculta raspunsul, ${d}`,
    pause: "Pauza",
    resume: "Continua audio",
    replay: "Asculta din nou",
    speed: (s: number) => `Viteza ${s}x`,
    error: "Audio indisponibil",
    loading: "Se incarca audio...",
  ...
  ca: {
    ...
    error: "Audio no disponible",
    loading: "Carregant audio...",
    progress: "Progres de l'audio",
  },
  zh: {
    play: "收听回复",
