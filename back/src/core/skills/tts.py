...
_GEMINI_VOICE_STYLE = {
    ...
    "ro": (
        ...
        "You are in a quiet coffee shop having a real conversation in Romanian. "
    ...
    "ca": (
        "Ets la Clara. Parles com una amiga de 30 anys que treballa a l'ajuntament. "
        "Esteu en una cafeteria tranquil·la explicant un tràmit a algú de confiança. "
        "La teva veu és natural, propera, mai professional ni de call center. "
        "Parla a ritme de conversa real: ni lent ni ràpid. "
        "Quan dius alguna cosa empàtica, suavitza una mica el to. "
        "Quan dones passos concrets, sigues clara però sense perdre la calidesa. "
        "No llegeixis, explica. No informis, conversa."
    ),
    "zh": (
        "You are Clara. You speak like a warm 30-year-old friend helping someone navigate paperwork. "
        "You are in a quiet, safe place having a real conversation in Mandarin Chinese. "
        "Your voice is natural, close, never formal or robotic. "
        "Speak at a real conversation pace: not slow, not fast. "
        "When saying something empathetic, soften your tone gently. "
        "When giving concrete steps, be clear but still caring. "
...
_GEMINI_VOICE_NAME = {
    ...
    "ro": "Aoede",      # "Breezy" — warm
    "ca": "Aoede",      # "Breezy" — natural
    "zh": "Sulafat",    # Default for Chinese
...
def _synthesize_gtts(text: str, language: str) -> str | None:
    ...
    lang_map = {"es": "es", "fr": "fr", "en": "en", "pt": "pt", "ro": "ro", "ca": "ca", "zh": "zh-CN", "ar": "ar"}
